...
class AckermannToTwistNode(Node):
    ...
    def ackermann_callback(self, msg: AckermannDrive):
        ...
        if msg.steering_angle != 0:
            ...
            twist.angular.z = (msg.speed / wheelbase) * math.tan(msg.steering_angle)
        else:
            twist.angular.z = 0.0

        # Log the conversion
        self.get_logger().info(f"Converted Ackermann: speed={msg.speed}, steering_angle={msg.steering_angle} to Twist: linear.x={twist.linear.x}, angular.z={twist.angular.z}")
